...
#    print('''INSERT INTO {table} VALUES (NULL, {spec_classID}, "{acc}", "{db}", "{name}", {sequenceID}, {subclass})'''.format(table = table_name, spec_classID = scid,
...
#        print('''INSERT INTO prefered VALUES ({a}, {sc})'''.format(sc = scid, a = aid))
